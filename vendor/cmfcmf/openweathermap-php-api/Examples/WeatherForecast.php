...
// Example 1: Get forecast for the next 10 days for Rishikesh.
$forecast = $owm->getWeatherForecast('Rishikesh', $units, $lang, '', 10);
echo "EXAMPLE 1<hr />\n\n\n";
...
$forecast = $owm->getWeatherForecast('Rishikesh', $units, $lang, '', 3);
echo "EXAMPLE 2<hr />\n\n\n";
